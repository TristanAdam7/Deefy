...
class DisplayPlaylistByIdAction extends Action
{
    ...
    private function renderIdForm(): string
    {
        return '
            <form action="index.php" method="GET">
                <h2>Afficher une playlist par ID</h2>
                
                <input type="hidden" name="action" value="display-playlist-by-id">
                
                <div>
                    <label for="id_playlist">Entrez l\'ID de la playlist :</label>
                    <input type="number" id="id_playlist" name="id" required>
                </div>
